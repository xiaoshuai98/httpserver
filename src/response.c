...
void response_server_error(struct hsevent *event, Request *request) {
...
const char* get_query_string(Request *request) {
 ...
 */
int response_cgi(struct hsevent *event, Request *request) {
